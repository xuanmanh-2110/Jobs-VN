                ...
                <div className="space-y-3">
                  {educations.map((edu, idx) => (
                    <div key={edu.id || idx} className="p-3 bg-gray-50 dark:bg-slate-800/60 rounded-xl border border-gray-100 dark:border-slate-800">
                      ...
                      <p className="text-xs font-semibold text-blue-700 dark:text-blue-400 mt-0.5">{edu.degree}</p>
                      {edu.desc && <p className="text-xs text-gray-600 dark:text-slate-300 mt-1">{edu.desc}</p>}
                    </div>
                  ))}
                </div>
              ) : (
